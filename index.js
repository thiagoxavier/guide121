function CreateWhatsappChatWidget(option = {
    ...
    function initWidget(){
        jQuery('body').append(`<div id="whatsapp_chat_widget">
            <div id="wa-widget-send-button" class="shake">
        ...
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box'>
                ...
                <div class='wa-chat-box-send'>
                    ...
                    <div class='wa-chat-box-poweredby'>Powered by <a href="https://guide121.com" target="_blank" style="color: #006eff6e;">guide 121</a></div>
                </div>
            </div>
        `);
